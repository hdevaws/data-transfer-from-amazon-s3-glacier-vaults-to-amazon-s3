        ...
        NagSuppressions.add_resource_suppressions(
            ...
            [
                ...
                },
                {
                    ...
                    "appliesTo": [
                        "Resource::arn:<AWS::Partition>:states:<AWS::Region>:<AWS::AccountId>:stateMachine:InventoryRetrievalStateMachine*",
                        "Resource::arn:<AWS::Partition>:states:<AWS::Region>:<AWS::AccountId>:execution:InventoryRetrievalStateMachine*",
                        "Resource::arn:<AWS::Partition>:states:<AWS::Region>:<AWS::AccountId>:stateMachine:RetrieveArchiveStateMachine*",
                        "Resource::arn:<AWS::Partition>:states:<AWS::Region>:<AWS::AccountId>:execution:RetrieveArchiveStateMachine*",
                        "Resource::arn:<AWS::Partition>:states:<AWS::Region>:<AWS::AccountId>:stateMachine:ExtendDownloadWindowStateMachine*",
                        "Resource::arn:<AWS::Partition>:states:<AWS::Region>:<AWS::AccountId>:execution:ExtendDownloadWindowStateMachine*",
                        "Resource::arn:<AWS::Partition>:states:<AWS::Region>:<AWS::AccountId>:stateMachine:OrchestratorStateMachine*",
                        "Resource::arn:<AWS::Partition>:states:<AWS::Region>:<AWS::AccountId>:execution:OrchestratorStateMachine*",
                    ],
                },
            ],
        )
